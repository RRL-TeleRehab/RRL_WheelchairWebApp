...
function getWheelchairModels(containerDiv){
  ...
  // var parametersAPIResponse = JSON.parse( localStorage.getItem('parametersAPIResponse') );
  // var parametersAPIResponse = ( localStorage.getItem('parametersAPIResponse') );
  // var params = (parametersAPIResponse);

  // var parametersAPIResponse = JSON.parse( localStorage.getItem('parameterOutput') );
  // var params = JSON.stringify(parametersAPIResponse);

  var parametersAPIResponse = ( localStorage.getItem('parameterOutput') );
  var params = (parametersAPIResponse);
  alert("params  "+params );
  ...
  xhr.onreadystatechange = function() { // Call a function when the state changes.
    if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
        ...
        var getChairsResponse = xhr.responseText;
        
        alert("getChairsResponse " + getChairsResponse);
        // console.log("Model " + JSON.parse(xhr.response));
