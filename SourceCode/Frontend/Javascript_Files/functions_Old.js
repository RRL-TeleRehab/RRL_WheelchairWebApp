...
const submitForm = (ev)=>{
    ...
    xhr.onreadystatechange = function() { // Call a function when the state changes.
      if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
          ...
          // localStorage.setItem('CSAOutputData', JSON.stringify(xhr.responseText) );
          // localStorage.setItem('CSAOutputData', xhr.responseText );


          var csaOutput = xhr.responseText;
          // var csaOutput = JSON.parse(xhr.response);
          // gofFormArr.push(csaOutput);
          // localStorage.setItem('CSAOutputData', gofFormArr);
          // localStorage.setItem('CSAOutputData', JSON.stringify(gofFormArr));
          // localStorage.setItem('CSAOutputData', JSON.stringify(csaOutput));
        ...
        // alert("csaOutput"+csaOutput.Weight);
          // localStorage.setItem('CSAOutputData', gofFormArr);
          localStorage.setItem('CSAOutputData', csaOutput);

          // localStorage.setItem('CSAOutputDataWt', csaOutput.Weight);
          // localStorage.setItem('CSAOutputDataSw', csaOutput.SeatWidth);
          // localStorage.setItem('CSAOutputDataSd', csaOutput.SeatDepth);
          // localStorage.setItem('CSAOutputDataRFSFH', csaOutput.RecommendedFSFH);
// localStorage.clear();
    ...
    //Reloads on same tab
    //window.location.href = "../Generic_Order_Form/GOForm.html";
